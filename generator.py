...
sounds = [
    {'name': 'stepsSound',
    'file': 'stone_steps.mp3'},
    {'name': 'roomSound',
    'file': 'horror-ambience.flac'},
    {'name': 'silenceSound',
    'file': 'silence.wav'},
    {'name': 'musicSound',
    'file': 'music-box-melody.wav'},
    {'name': 'mouseSound',
    'file': 'mouse-eating.wav'},
    {'name': 'openSound',
    'file': 'door_open.wav'},
    {'name': 'lockedSound',
    'file': 'door-knock.wav'},
    ...
    {'name': 'carpetSound',
    'file': 'carpet.mp3'},
    {'name': 'carpetDragSound',
    'file': 'open-box.wav'},
    {'name': 'carpetStompSound',
    'file': 'carpet-stomp.mp3'},
    {'name': 'mouseSound',
    'file': 'mouse-squeek.wav'},
    ]

def parseMap(htmlMap, sounds):
...
image, areas, sounds = parseMap(htmlMap, sounds)
...
for sound in sounds:
    print(f"""  var {sound['name']} = new Howl({{
